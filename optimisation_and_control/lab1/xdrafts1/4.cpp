...
void SimplexMethod() { 
    ...
    vector<vector<double>> matrix{ 
        {1, 1, 1, 0, 2},  // Update the last element for the first constraint to 2 (x = 2) 
        {2, 1, 0, 1, 2}   // Update the last element for the second constraint to 2 (y = 2) 
    }; 
 
    // Update the coefficients of the objective function to match the desired solution (max = 26) 
    vector<double> obj_function{-7, -6, 0, 0};  // Coefficients for the objective function 
    vector<double> obj_func2{-7, -6, 0, 0}; 
